 ...
 //     messageId, quickReplyPayload);
  ...
  console.log("Received message for user %d and page %d at %d with message: %s", 
    ...
    switch (messageText.toLowerCase()) {
      case 'image':
        //sendImageMessage(senderID, "https://ecutune-db.com/thumbnail2.jpg");
        break;
...
function callGetLocaleAPI(event, handleReceived) {
    ...
    var path = '/v2.10/' + userID +'?fields=first_name,last_name,profile_pic,locale,timezone,gender&access_token=' + PAGE_ACCESS_TOKEN;
    var options = {
      ...
      "call_to_actions":[ 
        {
          ...
          "url":"http://scengineering.net/centralinas/simulador-de-potencia/",
          "webview_height_ratio":"full"
        },
        {
          "type":"web_url",
          "title":"🚑 Soluções FAP",
          "url":"https://www.removerfap.com/",
          "webview_height_ratio":"full"
        },
	{
            "type":"postback",
